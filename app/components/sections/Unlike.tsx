...
const Unlike = () => {
  return (
    <div className="text-white">
      ...
      <div className="flex gap-6 overflow-x-auto md:flex-wrap">
        <div className="flex min-h-[48rem] w-full shrink-0 flex-col items-center justify-end rounded-[4.8rem] border border-transparent-white bg-glass-gradient p-8 text-center md:p-14">
        ...
        <div className="group  relative flex min-h-[48rem] w-full shrink-0  flex-col items-center justify-end rounded-[4.8rem] border border-transparent-white bg-glass-gradient p-8 text-center md:p-14">
          <div className=" mask-linear-faded pointer-events-none absolute top-[-8rem] w-[130%] ">
